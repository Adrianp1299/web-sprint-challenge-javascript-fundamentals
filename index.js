...
// because it is in the scope of the function and can reach up and out. if it was out of the myFunction it wouldnt beable to reach in.
...
function summation(number) {
  ...
  for(let i = 0; i <= number; i++){
    newNumber.push(starter + i)
  }
  const initialValue = 0
  const endNumber = newNumber.reduce((previousValue, currentValue)=>
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(zooAnimals){
    const USA = zooAnimals.reduce((accumulator, currentValue) => {
